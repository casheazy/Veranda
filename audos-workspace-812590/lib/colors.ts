...
export const tw = {
  ...
  button: {
    ...
    // Danger button
    danger: 'bg-[var(--space-semantic-danger)] hover:brightness-90 text-[var(--space-text-on-highlight)] font-medium transition-all',
  ...
  // ---------------------------------------------------------------------------
  dock: {
    active: 'bg-[var(--space-brand-primary)] text-[var(--space-text-on-primary)] shadow-[0_8px_24px_var(--space-shell-shadow)]',
    inactive: 'bg-[var(--space-surface-card)] hover:bg-[var(--space-surface-card-hover)] text-[var(--space-text-primary)] border border-[var(--space-border-default)]',
    glass: 'bg-[var(--space-surface-panel)]/90 backdrop-blur-lg rounded-2xl shadow-[0_12px_32px_var(--space-shell-shadow)] border border-[var(--space-border-default)]',
  },
