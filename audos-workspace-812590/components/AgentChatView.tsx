          ...
          <div className="mt-8 px-4">
            {isBeaconSpace ? (
              ...
              <div className="text-center text-[var(--space-text-secondary)]">
                ...
                <p className="text-sm">
                  Tell me the Lagos address or area you're about to pay rent on — I'll help you check
                  flood risk, grid power, network coverage, advertised security and your commute.
                </p>
                {starterPrompts.length > 0 && (
                  <div className="mt-5 flex flex-wrap justify-center gap-2">
                    {starterPrompts.map((prompt) => (
